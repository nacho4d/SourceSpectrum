								 ...
								 CGSize maxSize)
{
	...
	if (htmlData) {
		...
		_webView = [[WebView alloc] initWithFrame:_rect frameName:nil groupName:nil];
		[_webView scaleUnitSquareToSize:_scaleSize];
		[_webView.mainFrame.frameView setAllowsScrolling:NO];
		[_webView.mainFrame loadData:(__bridge NSData *)htmlData MIMEType:@"text/html" textEncodingName:@"utf-8" baseURL:nil];
